...
export const BusApi = createApi({
  ...
  endpoints: (builder) => ({
    ...
    getBusBoardingPoint: builder.query({
      query: ({ id }) => ({
        url: `bus/boarding-point/${id}`,
        method: 'GET',
      }),
    }),
    getBusDroppingPoint: builder.query({
      query: ({ id }) => ({
        url: `bus/dropping-point/${id}`,
        method: 'GET',
      }),
    }),
  }),
...
export const {
  ...
  useGetBusBoardingPointQuery,
  useGetBusDroppingPointQuery
} = BusApi;
